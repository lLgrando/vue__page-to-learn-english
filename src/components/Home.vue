...
<template>
    <div class="bg-indigo-100 lg:h-screen">
        <div class="h-full flex flex-column justify-center items-center pb-40">
            <div>
                <img src="../../public/image/logo.svg" alt="" class="w-36 color-indigo-100" width="144px" height="144px">
            </div>
            <div>
                <h1 class="font-sans text-5xl font-extrabold p-16 text-center text-clip text-wrap">Free exercices to improve your english!</h1>
            </div>
